...
Write a function named transformToLis that, given an object, returns an array of 
the key value pairs as html list items.
...
Write a function that, given an array of integer arrays as input, calculates the total sum of 
