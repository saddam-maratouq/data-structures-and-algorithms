...
numbers and returns a new array of each of those numbers raised to the 3rd power (hint: look up Math.pow()). 
...
Write a function named addOne that, given an array of 
numbers, uses map to return a new array with each value simply incremented by 1. 
------------------------------------------------------------------------------------------------ */
...
const addOne = (arr) => {
  // Solution code here...
let Newnum = arr.map(( item )=> item +1)
     return Newnum ;
...
describe('Testing challenge 3', () => {
  test('It should add a question mark to the end of each string', () => {
    expect(addQuestion(['hello', '301', 'students'])).
...
as your forLoopTwoToThe function from challenge 4, but uses forEach instead of a for loop.
------------------------------------------------------------------------------------------------ */
