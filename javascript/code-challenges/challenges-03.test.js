...
Write a function called addTwo that takes in an array and adds two to every value using a for
 loop. Place the new value in a new array. Return the new array.
------------------------------------------------------------------------------------------------ */
...
const typeNum = (arr) => {
  // Solution code here...
  let obj = arr.filter (( inx  ) =>   typeof inx ==='number' ) 
...
const containsAnd = (arr) => {
  // Solution code here...
     ...
     let x = arr.filter (( idx ) =>  idx.includes ('and')  
...
const oddValues = (arr) => {
  // Solution code here...
  let Num =   arr.filter (n => n % 2)  //////// this is like if statment cuz 1=true 0= faulse 
